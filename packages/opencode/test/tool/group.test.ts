...
describe("tool.group", () => {
  ...
  it.instance("description teaches grouping by common goal and parallel workstreams", () =>
    Effect.gen(function* () {
      const tool = yield* GroupTool
      const def = yield* tool.init()

      expect(def.description).toContain("# Group Tool")
      expect(def.description).toContain("cluster related work into one coordinated bucket")
      expect(def.description).toContain("cohort of nested task calls")
      expect(def.description).toContain("common goal")
      expect(def.description).toContain("shared objective")
      expect(def.description).toContain("parallel lanes")
      expect(def.description).toContain("ownership lane")
      expect(def.description).toContain("fan-out/fan-in")
      expect(def.description).toContain("Fan out related work")
      expect(def.description).toContain("Fan in the results")
      expect(def.description).toContain("scatter-gather")
      expect(def.description).toContain("grouped result")
      expect(def.description).toContain("completion barrier")
      expect(def.description).toContain("aggregation")
      expect(def.description).toContain("synthesis")
      expect(def.description).toContain("one grouped response")
      expect(def.description).toContain("Do not use `group` when")
      expect(def.description).toContain("one direct tool call or one direct task call is enough")
