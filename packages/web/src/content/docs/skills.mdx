...
OpenCode ships with built-in skills:

- `interface`: Contract-first handoff workflow for large orchestrated implementation. Use after planning and before multiple coder agents edit adjacent parts of a codebase; includes ownership, correctness, and review-focus hooks for orchestrator reconciliation.
- `customize-opencode`: Guidance for editing OpenCode configuration, agents, skills, plugins, MCP servers, and permission rules.
