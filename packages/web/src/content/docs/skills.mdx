...
- `interface`: Contract-first handoff workflow for large orchestrated implementation. Use after planning and before multiple coder agents edit adjacent parts of a codebase.
