...
An implementation agent for scoped, high-quality coding work. Users usually do not select Coder directly; Orchestrate dispatches coder agents through grouped Task calls after planning and interface or contract preparation, then reviews and reconciles their output.
