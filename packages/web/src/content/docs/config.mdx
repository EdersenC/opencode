...
To auto-approve safe project-local bash requests that would otherwise ask, set `permission_mode`:
...
Explicit deny rules still win, and unsafe or external commands still require approval.
